"""
Seed SHENOYS backend with multi-city cinemas, screens, seats, movies, showtimes.
"""
...
def seed(db_url: str | None = None) -> None:
    ...
    print(
        f"SHENOYS seeded: {len(CINEMAS)} cinemas in {CHAIN_CITY}, "
